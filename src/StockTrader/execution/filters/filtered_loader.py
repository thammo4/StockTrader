...
class FilteredCandidateLoader (DataLoader):
	...
	def load (self, **kwargs) -> pd.DataFrame:
		...
		logger.info(f"FilteredCandidateLoader: n0={n0}, equity={portfolio_state.total_equity:.2f}, optionbp={portfolio_state.option_buying_power:.2f}, req={portfolio_state.current_requirement:.2f}")
		...
		logger.info(
			f"FilteredCandidateLoader: n0={n0}, n1={len(df)} [filtered_loader]"
		)
