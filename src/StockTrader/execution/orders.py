...
ACTIVE_ORDER_STATUSES = {"PENDING", "SUBMITTED", "ACKNOWLEDGED", "PARTIAL"}

TERMINAL_ORDER_STATUSES = {"FILLED", "REJECTED", "EXPIRED", "CANCELLED", "SUBMIT_FAILED", "RESPONSE_PARSE_FAILED"}
