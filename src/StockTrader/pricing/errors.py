...
class PricingError(Exception):
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {"error_code": self.error_code, "message": self.message, "occ": self.occ, "details": self.details}
...
class QLibError(PricingError):
    ...
    def from_runtime_error(cls, e: RuntimeError, occ: Optional[str] = None) -> "QLibError":
        ...
        return cls(message=str(e), occ=occ, details={"original_type": type(e).__name__})
