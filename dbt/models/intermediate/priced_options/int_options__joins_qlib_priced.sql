...
-- 02:46:24  Running with dbt=1.7.19
-- 02:46:24  Registered adapter: duckdb=1.7.5
-- 02:46:25  Found 22 models, 98 tests, 1 seed, 6 sources, 0 exposures, 0 metrics, 787 macros, 0 groups, 0 semantic models
-- 02:46:25  
-- 02:46:26  Concurrency: 6 threads (target='dev')
-- 02:46:26  
-- 02:46:26  1 of 1 START sql incremental model main_intermediate.int_options__joins_qlib_priced  [RUN]
-- Killed
