...
log "1. Fetching market dates from upstream table: main_intermediate.int_options__joins_dividends"
...
log "4. Summarizing Results:"
log "Inserted=$n_inserted, Skipped=$n_skipped"
