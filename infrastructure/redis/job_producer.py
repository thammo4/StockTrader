...
from infrastructure.redis.job_schema import PricingJob, Q_PENDING, Q_PROCESSING, Q_COMPLETED, Q_FAILED
        ...
        for obj in objects:
            ...
            if m:
                ...
                if key not in seen_jobs:
                    seen_jobs.add(key)
                    jobs.append(PricingJob(batch_id=key[0], market_date=key[1], shard=key[2]))
