...
from infrastructure.redis.job_schema import PricingJob, Q_PENDING, Q_PROCESSING, Q_COMPLETED, Q_FAILED, WORKER_HEARTBEAT
...
class JobWorker:
    ...
    def write_results(self, job: PricingJob, df_results: pd.DataFrame, manifest: dict) -> str:
        ...
        self.minio.put_object(
            self.output_bucket, manifest_key, manifest_bffr, length=len(manifest_bytes), content_type="application/json"
        )
